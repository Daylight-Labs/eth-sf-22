...
class ReferralLinkSignup(TimestampedDeletableModel):
    ...
    amount_deposited = models.DecimalField(null=True, blank=True, max_digits = 10, decimal_places = 2)
    ...
    twab = models.DecimalField(null=True, blank=True, max_digits = 10, decimal_places = 2)
    reward_earned = models.DecimalField(null=True, blank=True, max_digits = 10, decimal_places = 2)
